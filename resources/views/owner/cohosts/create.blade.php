...
@section('title', 'Inviter un co-hôte - ' . $residence->name . ' - REZI')
        ...
        <form action="{{ route('owner.cohosts.store', $residence) }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-3">
                    @php
                        $perms = [
                            ...
                            'can_manage_pricing' => ['label' => 'Modifier les prix', 'desc' => 'Ajuster les tarifs et promotions', 'bg' => 'bg-orange-50', 'text' => 'text-orange-600', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'checked' => false],
                    ...
                    @foreach ($perms as $key => $perm)
                        <label class="flex items-start gap-4 p-4 border border-gray-200 rounded-xl cursor-pointer hover:bg-gray-50 has-checked:border-orange-500 has-checked:bg-orange-50/50 transition">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="flex items-center gap-3">
                    <input type="number" name="commission_percent" id="commission_percent"
                        ...
                        class="w-24 px-4 py-2.5 border border-gray-200 rounded-xl text-sm text-center focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <textarea name="notes" id="notes" rows="3"
                    ...
                    class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition resize-y">{{ old('notes') }}</textarea>
            </div>
