...
@section('owner-content')
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav class="flex items-center gap-2 text-xs text-gray-400 mb-6">
            <a href="{{ route('owner.dashboard') }}" class="hover:text-orange-500 transition">Tableau de bord</a>
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
            <a href="{{ route('owner.residences.show', $residence) }}"
                class="hover:text-orange-500 transition">{{ Str::limit($residence->name, 25) }}</a>
            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            </svg>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            @switch($cohost->status)
                                @case('accepted')
                                    <span
                                        class="inline-flex items-center gap-1 px-2.5 py-1 bg-orange-100 text-orange-600 text-xs font-semibold rounded-full">
