...
@section('title', 'Co-hôte — ' . $cohost->name . ' - REZI')
            ...
            <div class="p-6 border-b border-gray-100">
                <div class="flex items-start justify-between">
                    <div class="flex items-center gap-4">
                        @php
                            $gradients = ['from-orange-400 to-pink-500', 'from-blue-400 to-indigo-500', 'from-emerald-400 to-teal-500', 'from-purple-400 to-pink-500', 'from-amber-400 to-orange-500'];
                    ...
                    @switch($cohost->status)
                        @case('accepted')
                            <span class="inline-flex items-center gap-1 px-2.5 py-1 bg-orange-100 text-orange-600 text-xs font-semibold rounded-full">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    @if ($cohost->commission_percent)
                        <div>
                            ...
                            <p class="font-bold text-sm text-orange-600 mt-1">{{ $cohost->commission_percent }}%</p>
                        </div>
                    @endif
                </div>
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        @if ($cohost->status === 'accepted')
                            <a href="{{ route('owner.cohosts.edit', [$residence, $cohost]) }}"
                                class="text-xs text-orange-500 hover:text-orange-600 font-semibold transition">Modifier</a>
                        @endif
                    </div>
                        ...
                        <div class="space-y-3">
                            @foreach ($cohost->activities as $activity)
                                <div class="flex items-start gap-3 text-sm">
                                    <div class="w-2 h-2 rounded-full bg-orange-400 mt-1.5 shrink-0"></div>
                                    <div>
