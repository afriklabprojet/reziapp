...
@section('title', 'Dashboard - Espace Propriétaire | Rezi Studio Meublé Faya')
                ...
                <div class="mb-6 bg-linear-to-r from-[#F16A00] to-amber-500 rounded-2xl p-5 text-white shadow-lg shadow-none" x-data="{ closed: false }" x-show="!closed" x-transition>
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-[#FFE7D1] text-sm mt-0.5">Rejoignez {{ number_format($totalOwners) }}+ propriétaires actifs sur Rezi Studio Meublé Faya. Gratuit, sans commission.</p>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">Votre performance globale sur Rezi Studio Meublé Faya</p>
                            </div>
                            <span @class([
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            @else
                                <div class="p-10 sm:p-12 text-center">
                                    ...
                                    <p class="text-sm text-gray-500 mb-5">Publiez votre première résidence sur Rezi Studio Meublé Faya</p>
                                    <a href="{{ route('owner.residences.create') }}"
