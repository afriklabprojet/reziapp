...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form action="{{ route('owner.maintenance.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
        ...
        <div>
            ...
            <input type="text" name="title" value="{{ old('title') }}" class="w-full rounded-xl border-gray-200 focus:ring-orange-500 focus:border-orange-500 text-sm" placeholder="Ex: Fuite robinet salle de bain" required>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select name="priority" class="w-full rounded-xl border-gray-200 focus:ring-orange-500 focus:border-orange-500 text-sm" required>
        ...
        <div>
            ...
            <textarea name="description" rows="4" class="w-full rounded-xl border-gray-200 focus:ring-orange-500 focus:border-orange-500 text-sm" placeholder="Décrivez le problème en détail..." required>{{ old('description') }}</textarea>
