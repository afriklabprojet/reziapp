...
@section('title', 'Nouvelle assurance — Rezi Studio Meublé Faya')
    ...
    <form action="{{ route('owner.insurance.store') }}" method="POST" class="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="provider" value="{{ old('provider') }}" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" placeholder="Ex: NSIA, Allianz CI" required>
            ...
            <div>
                ...
                <input type="text" name="policy_number" value="{{ old('policy_number') }}" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" placeholder="POL-XXXXXXXXX">
        ...
        <div>
            ...
            <select name="coverage_type" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" required>
        ...
        <div>
            ...
            <input type="number" name="monthly_premium" value="{{ old('monthly_premium') }}" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" placeholder="25000" required>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" name="start_date" value="{{ old('start_date') }}" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" required>
                @error('start_date') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
            </div>
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1">Date de fin *</label>
                <input type="date" name="end_date" value="{{ old('end_date') }}" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" required>
        ...
        <div>
            ...
            <textarea name="notes" rows="2" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" placeholder="Informations complémentaires...">{{ old('notes') }}</textarea>
        </div>
