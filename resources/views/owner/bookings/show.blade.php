...
@section('title', 'Réservation #' . ($booking->reference ?? $booking->id) . ' | ReziApp')
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        ...
                        @if ($booking->residence)
                            <a href="{{ route('owner.residences.show', $booking->residence) }}"
                                ...
                                <div class="flex-1 min-w-0">
                                    <p
                                        class="text-sm font-bold text-gray-900 group-hover:text-[#CC5A00] transition-colors truncate">
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between pt-3 border-t border-gray-100">
                                ...
                                <span class="text-base font-extrabold text-[#CC5A00]">
