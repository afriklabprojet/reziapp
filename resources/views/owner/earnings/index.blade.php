...
@section('title', 'Mes Revenus | Rezi App')
    ...
    <div class="min-h-screen bg-gray-50/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <form action="{{ route('owner.earnings.index') }}" method="GET" class="flex flex-wrap items-end gap-3">
                    <div>
                        ...
                        <input type="date" name="start_date" value="{{ $startDate->format('Y-m-d') }}"
                            class="rounded-xl border border-gray-200 text-sm px-3 py-2.5 focus:border-[#FFD0A3] focus:ring focus:ring-orange-100 bg-gray-50/50">
                    </div>
                    <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
                    <p class="text-[11px] text-gray-400 font-medium mb-1">Commission Rezi App</p>
                    <p class="text-lg font-bold text-gray-900">
                            ...
                            @foreach ($earningsByResidence as $item)
                                <div>
                                    ...
                                    <div class="w-full bg-gray-100 rounded-full h-2">
                                        <div class="bg-[#F16A00] h-2 rounded-full transition-all duration-500"
            ...
            <div class="mt-6 bg-white rounded-2xl border border-blue-100 p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm font-bold text-gray-900">Commission Rezi App : {{ $commissionRate * 100 }}%</p>
                        ...
                        <form action="{{ route('owner.earnings.setup-pin') }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="password" name="current_password" required autocomplete="current-password"
                                    class="w-full rounded-xl border border-gray-200 text-sm px-3 py-2.5 focus:border-[#FFD0A3] focus:ring focus:ring-orange-100 bg-gray-50/50"
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="password" name="withdrawal_pin" required maxlength="4" pattern="\d{4}" inputmode="numeric" autocomplete="off"
                                        class="w-full rounded-xl border border-gray-200 text-lg px-3 py-2.5 focus:border-[#FFD0A3] focus:ring focus:ring-orange-100 bg-gray-50/50 tracking-[0.5em] text-center font-mono"
                                        placeholder="••••">
                            ...
                            <div x-show="showPayoutForm" x-transition class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                                ...
                                <form action="{{ route('owner.earnings.request-payout') }}" method="POST" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="password" name="withdrawal_pin" required maxlength="4" pattern="\d{4}" inputmode="numeric" autocomplete="off"
                                            class="w-full sm:w-48 rounded-xl border border-gray-200 text-lg px-3 py-2.5 focus:border-[#FFD0A3] focus:ring focus:ring-orange-100 bg-gray-50/50 tracking-[0.5em] text-center font-mono"
                                            placeholder="••••">
                                        @error('withdrawal_pin')
                                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                                        @enderror
