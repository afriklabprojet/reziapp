            ...
            <div class="flex items-start gap-3 px-4 py-3 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-700">
                ...
                <div>
                    ...
                    <p class="text-xs mt-0.5">Vous devez avoir au moins une résidence approuvée pour créer une campagne sponsorisée.
                        <a href="{{ route('owner.residences.create') }}" class="text-[#CC5A00] hover:underline font-semibold">Créer une résidence</a>
                    </p>
                </div>
            </div>
        @else
            <form action="{{ route('owner.marketing.sponsored.store') }}" method="POST" class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <select name="residence_id" required x-model="residenceId"
                        class="w-full text-sm border-gray-200 rounded-xl bg-gray-50 focus:ring-[#F16A00] focus:border-[#F16A00] transition-colors">
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center justify-between gap-2">
                                            ...
                                            <span
                                                class="text-sm font-bold text-[#CC5A00] whitespace-nowrap">{{ number_format($package['price'], 0, ',', ' ') }}
                ...
                <div class="grid grid-cols-3 gap-3">
                    @foreach ([['val' => '7', 'discount' => null], ['val' => '14', 'discount' => '-10%'], ['val' => '30', 'discount' => '-20%']] as $opt)
                        <label class="relative cursor-pointer">
                            ...
                            <div
                                class="border-2 rounded-2xl p-4 text-center transition-all peer-checked:border-[#F16A00] peer-checked:bg-[#FFF4EB]/50 peer-checked:shadow-sm border-gray-100 hover:border-gray-200">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="daily_budget" id="daily_budget"
                                ...
                                class="w-full text-sm border-gray-200 rounded-xl bg-gray-50 focus:ring-[#F16A00] focus:border-[#F16A00] pr-16 transition-colors">
                            <span
                ...
                <div class="space-y-2.5 text-sm">
                    ...
                    <div class="border-t border-gray-200 pt-3 mt-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-xl font-bold text-[#CC5A00]"
