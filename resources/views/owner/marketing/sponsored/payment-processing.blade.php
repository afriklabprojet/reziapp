        ...
        <div x-show="status === 'pending'" class="text-center space-y-6">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6">
                ...
                <div class="flex justify-center">
                    <div class="relative">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <svg class="w-8 h-8 text-[#F16A00]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="flex items-center justify-center gap-2">
                    <div class="w-2 h-2 rounded-full bg-[#F16A00] animate-bounce" style="animation-delay: 0s"></div>
                    <div class="w-2 h-2 rounded-full bg-[#F16A00] animate-bounce" style="animation-delay: 0.2s"></div>
                    <div class="w-2 h-2 rounded-full bg-[#F16A00] animate-bounce" style="animation-delay: 0.4s"></div>
                </div>
