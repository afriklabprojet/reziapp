        ...
        <div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                @elseif ($sponsored->status === 'pending')
                    <span
                        class="self-start inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-full bg-orange-50 text-orange-700 border border-orange-200">
                        ...
                        <div>
                            ...
                            @if ($sponsored->total_budget)
                                ...
                                <div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                                    <div class="h-full rounded-full transition-all duration-500 {{ $budgetPct >= 90 ? 'bg-red-500' : ($budgetPct >= 60 ? 'bg-orange-400' : 'bg-green-500') }}"
