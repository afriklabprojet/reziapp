                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="residence_id" id="residence_id" x-model="residenceId"
                                        class="w-full border-gray-200 rounded-xl focus:ring-orange-500 focus:border-orange-500 py-3 bg-gray-50 focus:bg-white transition appearance-none pl-4 pr-10"
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" x-model="description" rows="2" maxlength="500"
                                    ...
                                    class="w-full border-gray-200 rounded-xl focus:ring-orange-500 focus:border-orange-500 py-3 bg-gray-50 focus:bg-white transition resize-none">{{ old('description') }}</textarea>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <label
                                        ...
                                        <div class="shrink-0 w-10 h-10 rounded-lg flex items-center justify-center text-lg transition-colors"
                                            :class="discountType === 'fixed' ? 'bg-orange-100' : 'bg-gray-100'">
                                            F
                                        </div>
                                        <div>
                ...
                <div class="lg:col-span-2">
                    <div class="lg:sticky lg:top-24 space-y-5">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                            ...
                            <div class="p-5">
                                <div
                                    class="relative bg-linear-to-br from-orange-500 to-orange-600 rounded-2xl p-5 text-white overflow-hidden">
                                    ...
                                    <div class="relative">
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-xs font-medium opacity-80 uppercase tracking-wider">REZI
                                                    Promo</span>
                                            </div>
                                        ...
                                        <div
                                            ...
                                            <span x-text="code.toUpperCase() || 'REZIXXX'"></span>
                                        </div>
