            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div
                        ...
                        {{ $coupon->isValid() ? 'bg-linear-to-br from-orange-500 to-orange-600' : ($coupon->is_active && $coupon->expires_at && $coupon->expires_at->isPast() ? 'bg-linear-to-br from-amber-400 to-amber-500' : 'bg-linear-to-br from-gray-300 to-gray-400') }}
                        text-white">
                        {{-- Ticket holes --}}
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-5">
                        ...
                        <div class="bg-gray-50 rounded-xl p-4">
                            ...
                            <p class="font-semibold text-orange-600 text-lg">{{ $coupon->discount_label }}</p>
                        </div>
                        <div class="bg-gray-50 rounded-xl p-4">
                                ...
                                <div class="px-6 py-4 flex items-center justify-between hover:bg-gray-50/50 transition">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 bg-orange-50 rounded-full flex items-center justify-center">
                                            <span
                                                class="text-sm font-bold text-orange-600">{{ mb_substr($use->user->name ?? 'U', 0, 1) }}</span>
                                        </div>
                                        <div>
            ...
            <div class="space-y-5">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-2">
                    ...
                    <a href="{{ route('owner.marketing.coupons.edit', $coupon) }}"
                        class="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-orange-50 transition text-sm font-medium text-gray-700 hover:text-orange-700">
