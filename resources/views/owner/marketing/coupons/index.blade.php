            ...
            <form method="GET" class="flex flex-wrap items-center gap-3">
                <div class="flex-1 min-w-44">
                    <select name="residence_id"
                        class="w-full border-gray-200 rounded-xl text-sm focus:ring-orange-500 focus:border-orange-500 py-2.5 bg-gray-50 focus:bg-white transition">
                            ...
                            <div class="space-y-2.5 mb-4">
                                ...
                                @if ($coupon->max_uses)
                                    <div class="w-full bg-gray-100 rounded-full h-1.5">
                                        <div class="h-1.5 rounded-full transition-all {{ $coupon->uses_count >= $coupon->max_uses ? 'bg-red-500' : 'bg-orange-500' }}"
