            ...
            <form method="GET" class="flex flex-wrap items-center gap-3">
                <div class="flex-1 min-w-44">
                    <select name="residence_id"
                        class="w-full border-gray-200 rounded-xl text-sm focus:ring-[#ff385c] focus:border-[#ff385c] py-2.5 bg-gray-50 focus:bg-white transition">
                            ...
                            <div class="space-y-2.5 mb-4">
                                ...
                                @if ($coupon->max_uses)
                                    <div class="w-full bg-gray-100 rounded-full h-1.5">
                                        <div class="h-1.5 rounded-full transition-all {{ $coupon->uses_count >= $coupon->max_uses ? 'bg-red-500' : 'bg-[#ff385c]' }}"
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                ...
                                <div class="flex items-center gap-0.5">
                                    ...
                                    <a href="{{ route('owner.marketing.coupons.edit', $coupon) }}"
                                        class="p-2 text-gray-400 hover:text-[#e00b41] hover:bg-[#fff0f3] rounded-lg transition"
                                        title="Modifier">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <tr class="hover:bg-gray-50/50 transition">
                                    ...
                                    <td class="px-5 py-4 whitespace-nowrap text-right">
                                        <div class="flex items-center justify-end gap-0.5">
                                            ...
                                            <a href="{{ route('owner.marketing.coupons.edit', $coupon) }}"
                                                class="p-1.5 text-gray-400 hover:text-[#e00b41] hover:bg-[#fff0f3] rounded-lg transition"
                                                title="Modifier">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
