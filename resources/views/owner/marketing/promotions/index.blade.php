        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 flex items-center gap-2.5">
                    <span
                        class="inline-flex items-center justify-center w-9 h-9 rounded-xl bg-linear-to-br from-orange-500 to-red-500 text-white shadow-sm">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-2xl font-bold text-gray-900">{{ $stats['total'] - $stats['active'] }}</p>
                        <p class="text-[11px] text-gray-500 font-medium">Expirées / Off</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <div class="flex items-center bg-gray-100 rounded-lg p-0.5">
                    <button @click="setView('cards')" type="button"
                        ...
                        :class="view === 'cards' ? 'bg-white shadow-sm text-orange-600' : 'text-gray-400 hover:text-gray-600'">
                    ...
                    <button @click="setView('table')" type="button"
                        class="p-2 rounded-md transition-all"
                        :class="view === 'table' ? 'bg-white shadow-sm text-orange-600' : 'text-gray-400 hover:text-gray-600'">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center gap-4 p-5">
                            ...
                            <div class="shrink-0">
                                <div
                                    ...
                                    {{ $isActive ? 'bg-linear-to-br from-red-500 to-orange-500 text-white shadow-lg shadow-red-500/20' : ($isExpired ? 'bg-gray-100 text-gray-400' : ($isUpcoming ? 'bg-linear-to-br from-blue-500 to-indigo-500 text-white shadow-lg shadow-blue-500/20' : 'bg-gray-100 text-gray-500')) }}">
                                ...
                                @if ($progressPercent !== null)
                                    <div class="mt-3 max-w-xs">
                                        ...
                                        <div class="w-full h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                            <div class="h-full rounded-full transition-all duration-500 {{ $progressPercent >= 80 ? 'bg-red-500' : ($progressPercent >= 50 ? 'bg-orange-400' : 'bg-green-500') }}"
