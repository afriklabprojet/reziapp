...
@section('owner-content')
    <div class="max-w-2xl mx-auto space-y-6" x-data="shareReferral">
        ...
        <div>
            ...
            <p class="text-gray-500 mt-1">Invitez vos amis à rejoindre REZI et gagnez des récompenses</p>
        </div>

        {{-- Referral Code Card --}}
        <div
            class="bg-linear-to-br from-orange-500 via-orange-600 to-orange-700 rounded-2xl p-8 text-white text-center relative overflow-hidden shadow-lg">
            ...
            <div class="relative">
                ...
                <p class="text-orange-100 text-sm mb-2">Votre code de parrainage</p>
                <code
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('owner.marketing.referrals.share', ['channel' => 'email']) }}"
                    class="flex items-center gap-3 p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all group">
                    <div
                        class="w-12 h-12 bg-orange-500 rounded-xl flex items-center justify-center text-white shrink-0 shadow-sm">
                    ...
                    <div>
                        <p class="font-semibold text-gray-900 text-sm group-hover:text-orange-700">Email</p>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                <div class="flex items-start gap-4">
                    <div
                        class="w-8 h-8 bg-orange-100 text-orange-600 rounded-lg flex items-center justify-center font-bold text-sm shrink-0">
                        1</div>
                    <div>
