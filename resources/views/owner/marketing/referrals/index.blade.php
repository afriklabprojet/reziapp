...
@section('owner-content')
    <div class="space-y-6" x-data="referralPage">
        ...
        <div
            class="bg-linear-to-br from-orange-500 via-orange-600 to-orange-700 rounded-2xl p-6 sm:p-8 text-white shadow-lg relative overflow-hidden">
            {{-- Decorative circles --}}
            ...
            <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                <div class="flex-1">
                    ...
                    <p class="text-orange-100 mb-5 text-sm">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="relative text-center p-4">
                    <div class="w-12 h-12 mx-auto bg-orange-100 rounded-2xl flex items-center justify-center mb-3">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            @if ($referrals->isEmpty())
                <div class="text-center py-16 px-6">
                    ...
                    <button @click="copyCode('{{ auth()->user()->referral_code }}')"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-orange-600 text-white text-sm font-medium rounded-xl hover:bg-orange-700 transition">
                            ...
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 bg-orange-100 rounded-full flex items-center justify-center">
                                        <span
                                            class="text-orange-600 font-semibold text-sm">{{ substr($referral->referred->name ?? 'U', 0, 1) }}</span>
                                    </div>
                                    <div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        @if ($referral->status === 'qualified' && !$referral->rewarded_at)
                                            <form action="{{ route('owner.marketing.referrals.claim', $referral) }}"
                                                ...
                                                @csrf
                                                <button type="submit"
                                                    class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-orange-600 text-white text-xs font-medium rounded-lg hover:bg-orange-700 transition shadow-sm">
