...
@section('title', 'Relevés de compteurs — Rezi Studio Meublé Faya')
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-md text-[10px] font-bold uppercase {{ $reading->utility_type === 'electricity' ? 'bg-yellow-100 text-yellow-700' : ($reading->utility_type === 'water' ? 'bg-blue-100 text-blue-700' : 'bg-[#FFE7D1] text-[#A34700]') }}">
