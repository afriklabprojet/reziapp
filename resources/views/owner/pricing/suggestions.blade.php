...
@section('owner-content')
    <div class="space-y-6" x-data="priceSuggestions({{ alpine_encode(['applyUrl' => route('owner.pricing.apply', $residence), 'csrfToken' => csrf_token()]) }})">
        <!-- En-tête -->
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <nav class="text-sm text-gray-500 mb-2">
                    <a href="{{ route('owner.residences.index') }}" class="hover:text-[#CC5A00]">Mes résidences</a>
                    <span class="mx-2">›</span>
                    <a href="{{ route('owner.pricing.index', $residence) }}" class="hover:text-[#CC5A00]">Tarification</a>
                    <span class="mx-2">›</span>
        ...
        <!-- Résumé -->
        <div class="bg-linear-to-r from-purple-600 to-[#F16A00] rounded-2xl p-6 text-white">
                    ...
                    @foreach ($suggestions['immediate'] as $suggestion)
                        <div class="p-4 hover:bg-gray-50 flex items-center gap-4">
                            ...
                            <div class="text-right">
                                ...
                                <div
                                    class="text-lg font-bold {{ $suggestion['adjustment'] >= 0 ? 'text-green-600' : 'text-[#CC5A00]' }}">
                                    {{ number_format($suggestion['suggested_price'], 0, ',', ' ') }} F
                                </div>
                                <div
                                    class="text-xs {{ $suggestion['adjustment'] >= 0 ? 'text-green-600' : 'text-[#CC5A00]' }}">
                        ...
                        <div class="p-6 hover:bg-gray-50">
                            <div class="flex items-start justify-between">
                                ...
                                <div class="text-right">
                                    ...
                                    <div
                                        class="text-sm {{ $season['avg_adjustment'] >= 0 ? 'text-green-600' : 'text-[#CC5A00]' }}">
