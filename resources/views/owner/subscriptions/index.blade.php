...
@section('title', 'Commission Rezi App - Rezi App')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8 rounded-3xl bg-linear-to-br from-gray-950 via-gray-900 to-orange-900 px-6 py-8 text-white shadow-2xl">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div class="max-w-2xl">
                ...
                <h1 class="mt-4 text-3xl font-bold sm:text-4xl">Rezi App prélève {{ rtrim(rtrim(number_format($commissionRate, 2, ',', ' '), '0'), ',') }}% sur chaque réservation propriétaire</h1>
            ...
            <div class="rounded-2xl border border-white/10 bg-white/10 px-5 py-4 backdrop-blur">
                ...
                <p class="mt-3 text-lg font-semibold text-orange-200">Commission Rezi App: {{ number_format($exampleCommissionAmount, 0, ',', ' ') }} FCFA</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-5 md:grid-cols-4">
        ...
        <div class="rounded-2xl border border-orange-200 bg-orange-50 p-5 shadow-sm">
            <p class="text-sm font-medium text-orange-700">Commission Rezi App</p>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Chaque ligne reprend le montant total de la réservation et la retenue Rezi App appliquée côté propriétaire.</p>
                </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <ol class="mt-5 space-y-4 text-sm text-gray-600">
                ...
                <li class="flex gap-3">
                    ...
                    <span>Rezi App retient {{ rtrim(rtrim(number_format($commissionRate, 2, ',', ' '), '0'), ',') }}% du montant total de la réservation, côté propriétaire.</span>
                </li>
                <li class="flex gap-3">
            ...
            <div class="mt-6 rounded-2xl bg-gray-50 p-4">
                ...
                <p class="mt-2 text-sm text-gray-600">Il n'existe plus de plan mensuel, annuel ou formule d'abonnement à souscrire sur Rezi App pour les propriétaires.</p>
            </div>
