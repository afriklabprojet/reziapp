...
@section('title', 'Mes contacts - Rezi Studio Meublé Faya')
        ...
        <div class="bg-white border-b border-gray-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5">
                    ...
                    <div class="bg-gray-50 rounded-xl p-3 flex items-center gap-3">
                        <div class="w-9 h-9 bg-[#FFE7D1] rounded-lg flex items-center justify-center shrink-0">
                            <svg class="w-4.5 h-4.5 text-[#CC5A00]" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <form method="GET" action="{{ route('owner.contacts.index') }}" class="flex-1 flex gap-3">
                        ...
                        <button type="submit"
                            class="px-4 py-2.5 bg-[#F16A00] text-white rounded-xl text-sm font-semibold hover:bg-[#CC5A00] transition-colors shrink-0">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                            </svg>
            ...
            @if ($contacts->isNotEmpty())
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden divide-y divide-gray-50">
                    @foreach ($contacts as $contact)
                        ...
                        @endphp
                        <div class="p-4 sm:p-5 hover:bg-gray-50/50 transition-colors {{ $isPending ? 'bg-[#FFF4EB]/20' : '' }}"
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-xs text-gray-500 mt-0.5 truncate">
                                                ...
                                                <a href="{{ route('owner.residences.show', $contact->residence) }}"
                                                    class="text-[#CC5A00] hover:text-[#A34700] font-medium">{{ $contact->residence->name ?? 'Résidence' }}</a>
                                        ...
                                        <div class="flex items-center gap-1.5 ml-auto">
                                            ...
                                            @if ($contact->status !== 'responded')
                                                <form action="{{ route('owner.contacts.respond', $contact) }}"
                                                    ...
                                                    @method('PATCH')
                                                    <button type="submit"
                                                        class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#FFF4EB] text-[#A34700] text-[11px] font-semibold rounded-lg hover:bg-[#FFE7D1] transition-colors"
