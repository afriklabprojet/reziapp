                            ...
                            <a href="{{ route('owner.residences.show', $contact->residence) }}"
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="text-sm font-bold text-gray-900 group-hover:text-orange-600 transition-colors truncate">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        @if ($contact->phone ?? $contact->user->phone)
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contact->phone ?? $contact->user->phone) }}"
                                target="_blank"
                                class="inline-flex items-center gap-2 px-4 py-2.5 bg-green-500 text-white text-sm font-semibold rounded-xl hover:bg-green-600 transition-colors shadow-sm">
