...
@section('title', 'Nouvelle réponse automatique - Rezi App')
...
@section('owner-content')
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('owner.auto-replies.store') }}" method="POST" class="space-y-6"
            x-data="autoReplyForm({{ alpine_encode(['triggerType' => old('trigger_type', request('template', 'manual')), 'keywords' => old('trigger_conditions.keywords', [])]) }})">
            @csrf
