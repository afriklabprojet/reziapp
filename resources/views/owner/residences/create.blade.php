        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <a href="{{ route('owner.residences.index') }}"
                    class="inline-flex items-center text-orange-500 hover:text-orange-600 mb-4">
            ...
            <form method="POST" action="{{ route('owner.residences.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 resize-none">{{ old('description') }}</textarea>
                            <div class="flex justify-end mt-1">
                                <span class="text-sm" :class="description.length >= 50 ? 'text-orange-500' : 'text-gray-400'">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">2</span>
                        ...
                        <div class="flex items-center">
                            <label class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 w-full">
                                <input type="checkbox" name="has_elevator" value="1"
                                    class="w-5 h-5 text-orange-500 rounded" {{ old('has_elevator') ? 'checked' : '' }}>
                                <div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">3</span>
                            ...
                            <div class="flex items-center">
                                <label class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 w-full">
                                    <input type="checkbox" name="deposit_negotiable" value="1"
                                        class="w-5 h-5 text-orange-500 rounded" {{ old('deposit_negotiable') ? 'checked' : '' }}>
                                    <div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">4</span>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">5</span>
                        ...
                        <div class="flex items-center">
                            <label class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 w-full">
                                <input type="checkbox" name="is_available" value="1"
                                    class="w-5 h-5 text-orange-500 rounded" {{ old('is_available', true) ? 'checked' : '' }}>
                                <div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">6</span>
                        <h2 class="text-xl font-semibold text-gray-900">Règles de la maison</h2>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        {{-- Animaux --}}
                        <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                            <input type="checkbox" name="pets_allowed" value="1"
                                class="w-5 h-5 text-orange-500 rounded" {{ old('pets_allowed') ? 'checked' : '' }}>
                            <div class="ml-3">
                        ...
                        <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                            <input type="checkbox" name="smoking_allowed" value="1"
                                class="w-5 h-5 text-orange-500 rounded" {{ old('smoking_allowed') ? 'checked' : '' }}>
                            <div class="ml-3">
                        ...
                        <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                            <input type="checkbox" name="parties_allowed" value="1"
                                class="w-5 h-5 text-orange-500 rounded" {{ old('parties_allowed') ? 'checked' : '' }}>
                            <div class="ml-3">
                    ...
                    <div>
                        ...
                        <textarea id="house_rules" name="house_rules" rows="3" x-model="houseRules"
                            ...
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 resize-none">{{ old('house_rules') }}</textarea>
                        <div class="flex justify-end mt-1">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
                            ...
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="target_tenants[]" value="families"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('families', old('target_tenants', [])) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700">Familles</span>
                            </label>
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="target_tenants[]" value="professionals"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('professionals', old('target_tenants', [])) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700">Professionnels</span>
                            </label>
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="target_tenants[]" value="couples"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('couples', old('target_tenants', [])) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700">Couples</span>
                            </label>
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="target_tenants[]" value="tourists"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('tourists', old('target_tenants', [])) ? 'checked' : '' }}>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">7</span>
                        <h2 class="text-xl font-semibold text-gray-900">Accessibilité</h2>
                    </div>

                    <div class="space-y-4">
                        <label class="flex items-center gap-3 p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300">
                            <input type="checkbox" name="is_accessible" value="1"
                                class="w-5 h-5 text-orange-500 rounded" {{ old('is_accessible') ? 'checked' : '' }}>
                            <div>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="accessibility_features[]" value="wheelchair_ramp"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('wheelchair_ramp', old('accessibility_features', [])) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700">Rampe d'accès</span>
                            </label>
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="accessibility_features[]" value="wide_doors"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('wide_doors', old('accessibility_features', [])) ? 'checked' : '' }}>
                            ...
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="accessibility_features[]" value="accessible_bathroom"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('accessible_bathroom', old('accessibility_features', [])) ? 'checked' : '' }}>
                            ...
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="accessibility_features[]" value="grab_bars"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('grab_bars', old('accessibility_features', [])) ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700">Barres d'appui</span>
                            </label>
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="accessibility_features[]" value="step_free"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('step_free', old('accessibility_features', [])) ? 'checked' : '' }}>
                            ...
                            <label class="flex items-center p-3 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 has-checked:border-orange-500 has-checked:bg-orange-50">
                                <input type="checkbox" name="accessibility_features[]" value="accessible_parking"
                                    class="w-4 h-4 text-orange-500 rounded" {{ in_array('accessible_parking', old('accessibility_features', [])) ? 'checked' : '' }}>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">8</span>
                        <h2 class="text-xl font-semibold text-gray-900">Équipements</h2>
                    </div>

                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        @foreach($amenities ?? [] as $amenity)
                            <label class="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:border-orange-300 hover:bg-orange-50 has-checked:border-orange-500 has-checked:bg-orange-50">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">9</span>
                        ...
                        <div x-show="previews.length > 0" class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <template x-for="(preview, index) in previews" :key="index">
                                <div class="relative aspect-square rounded-lg overflow-hidden border">
                                    ...
                                    <span x-show="index === 0"
                                        class="absolute bottom-2 left-2 px-2 py-1 bg-orange-500 text-white text-xs rounded">Principale</span>
                                </div>
                            </template>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center mb-6">
                        <span class="flex items-center justify-center w-8 h-8 bg-orange-100 text-orange-500 rounded-full text-sm font-bold mr-3">10</span>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-end">
                    ...
                    <button type="submit"
                        class="px-8 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 font-medium flex items-center justify-center gap-2">
