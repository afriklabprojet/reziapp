...
@section('title', 'Mes résidences - Rezi Studio Meublé Faya')
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                            ...
                                            @if (in_array($residence->status, ['active', 'approved']))
                                                <a href="{{ route('residences.show', $residence) }}" target="_blank"
                                                    ...
                                                    Voir sur Rezi Studio Meublé Faya
                                                </a>
                                            @endif
                                            ...
                                            <div class="my-1 border-t border-gray-100"></div>
                                            <form method="POST"
                                                action="{{ route('owner.residences.destroy', $residence) }}"
                                                @submit.prevent="if(confirm('Supprimer « {{ addslashes($residence->title) }} » ? Cette action est irréversible.')) $el.submit()">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
