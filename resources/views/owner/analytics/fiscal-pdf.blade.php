...
<body>
    <div class="container">
        ...
        <div class="legal-notice">
            ...
            Ce document est généré automatiquement par la plateforme Rezi Studio Meublé Faya à titre informatif uniquement.
        ...
        <div class="signature-area">
            ...
            <div class="signature-box">
                <p>Cachet Rezi Studio Meublé Faya</p>
                <div class="signature-line">Pour la plateforme Rezi Studio Meublé Faya</div>
            </div>
        </div>
        ...
        <div class="footer">
            ...
            <p class="footer-note">Rezi Studio Meublé Faya - Plateforme de location de résidences meublées en Afrique de l'Ouest</p>
            <p class="footer-note">© {{ date('Y') }} Rezi Studio Meublé Faya - Tous droits réservés</p>
        </div>
    </div>
</body>
