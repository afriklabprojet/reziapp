...
<div class="space-y-6">
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
            <nav class="text-sm text-gray-500 mb-2">
                <a href="{{ route('owner.analytics.index') }}" class="hover:text-orange-500">Analytics</a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div class="bg-linear-to-br from-orange-500 to-orange-500 rounded-2xl p-6 text-white">
            <p class="text-orange-100 text-sm">Revenus bruts annuels</p>
            <p class="text-3xl font-bold mt-2">{{ number_format($fiscalData['totals']['revenue'], 0, ',', ' ') }}</p>
            <p class="text-orange-100 text-sm mt-1">FCFA</p>
        </div>
            ...
            <table class="w-full">
                ...
                <tfoot class="bg-orange-50">
                    <tr class="font-bold">
                        ...
                        <td class="px-6 py-4 text-right text-orange-600">{{ number_format($fiscalData['fiscal']['net_revenue'], 0, ',', ' ') }} F</td>
                    </tr>
                </tfoot>
            </table>
        </div>
    ...
    <div class="flex justify-center gap-4">
        ...
        <a href="{{ route('owner.analytics.export.fiscal-pdf', ['year' => $year]) }}" 
           class="px-6 py-3 bg-orange-500 text-white rounded-xl hover:bg-orange-600 transition inline-flex items-center gap-2">
