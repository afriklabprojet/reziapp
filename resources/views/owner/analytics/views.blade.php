                                ...
                                <div>
                                    <div class="flex items-center justify-between mb-1.5">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="w-2 h-2 rounded-full {{ ['bg-purple-500', 'bg-blue-500', 'bg-green-500', 'bg-[#F16A00]', 'bg-pink-500'][$loop->index % 5] }}">
                                            </div>
                                            <span
                                    ...
                                    <div class="w-full bg-gray-100 rounded-full h-2 overflow-hidden">
                                        <div class="h-full {{ ['bg-purple-500', 'bg-blue-500', 'bg-green-500', 'bg-[#F16A00]', 'bg-pink-500'][$loop->index % 5] }} rounded-full transition-all duration-700"
