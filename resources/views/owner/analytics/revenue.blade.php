    ...
    <div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('owner.analytics.export.pdf', ['start_date' => $startDate->format('Y-m-d'), 'end_date' => $endDate->format('Y-m-d')]) }}"
               class="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 text-white text-sm font-semibold rounded-xl hover:bg-orange-600 transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form action="{{ route('owner.analytics.revenue') }}" method="GET" class="flex flex-wrap items-end gap-3">
            <div class="flex-1 min-w-35">
                ...
                <input type="date" name="start_date" value="{{ $startDate->format('Y-m-d') }}"
                       class="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition">
            </div>
            <div class="flex-1 min-w-35">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1.5">
                                <div class="flex items-center gap-2">
                                    <div class="w-2 h-2 rounded-full bg-orange-{{ 500 - $loop->index * 100 >= 200 ? 500 - $loop->index * 100 : 200 }}"></div>
                    ...
                    <table class="w-full">
                            ...
                            @foreach($revenueStats['by_day'] as $day)
                                <tr class="hover:bg-gray-50/50 transition">
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-orange-50 text-orange-600">
                        ...
                        <tfoot class="bg-orange-50/50">
                            <tr>
                                ...
                                <td class="px-5 py-3 text-sm font-extrabold text-orange-600 text-right">{{ number_format($revenueStats['confirmed'] ?? 0, 0, ',', ' ') }} FCFA</td>
                                <td class="px-5 py-3 text-right">
                                    <span class="text-[11px] font-bold text-orange-600">100%</span>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
