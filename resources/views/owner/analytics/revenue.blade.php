...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <div>
        <a href="{{ route('owner.analytics.index') }}"
           class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#F16A00] transition mb-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <a href="{{ route('owner.analytics.export.pdf', ['start_date' => $startDate->format('Y-m-d'), 'end_date' => $endDate->format('Y-m-d')]) }}"
               class="inline-flex items-center gap-2 px-4 py-2 bg-[#F16A00] text-white text-sm font-semibold rounded-xl hover:bg-[#CC5A00] transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <form action="{{ route('owner.analytics.revenue') }}" method="GET" class="flex flex-wrap items-end gap-3">
            <div class="flex-1 min-w-35">
                ...
                <input type="date" name="start_date" value="{{ $startDate->format('Y-m-d') }}"
                       class="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#F16A00]/20 focus:border-[#F16A00] transition">
            </div>
            <div class="flex-1 min-w-35">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1.5">
                                <div class="flex items-center gap-2">
                                    <div class="w-2 h-2 rounded-full bg-[#F16A00]"></div>
                            ...
                            <div class="w-full bg-gray-100 rounded-full h-2 overflow-hidden">
                                <div class="h-full bg-[#F16A00] rounded-full transition-all duration-700"
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="w-full">
                            ...
                            @foreach($revenueStats['by_day'] as $day)
                                <tr class="hover:bg-gray-50/50 transition">
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-[#FFF4EB] text-[#CC5A00]">
                        ...
                        <tfoot class="bg-[#FFF4EB]/50">
                            <tr>
                                <td class="px-5 py-3 text-sm font-bold text-gray-900">Total</td>
                                <td class="px-5 py-3 text-sm font-extrabold text-[#CC5A00] text-right">{{ number_format($revenueStats['confirmed'] ?? 0, 0, ',', ' ') }} FCFA</td>
                                <td class="px-5 py-3 text-right">
                                    <span class="text-[11px] font-bold text-[#CC5A00]">100%</span>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
