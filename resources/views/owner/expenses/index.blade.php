...
@section('title', 'Charges & Dépenses — REZI')
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr>
                        <td colspan="6" class="px-5 py-12 text-center text-gray-400">
                            ...
                            <a href="{{ route('owner.expenses.create') }}" class="text-orange-600 hover:text-orange-700 text-sm font-medium mt-1 inline-block">Ajouter votre première dépense</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
