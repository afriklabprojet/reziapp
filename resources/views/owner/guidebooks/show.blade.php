...
@section('title', $guidebook->title . ' — Rezi Studio Meublé Faya')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex gap-2">
            <form action="{{ route('owner.guidebooks.toggle-publish', $guidebook) }}" method="POST">
                @csrf
                <button type="submit" class="inline-flex items-center gap-2 px-4 py-2.5 {{ $guidebook->is_published ? 'bg-[#FFF4EB] text-[#A34700] hover:bg-[#FFE7D1]' : 'bg-green-50 text-green-700 hover:bg-green-100' }} font-semibold rounded-xl transition-all text-sm">
