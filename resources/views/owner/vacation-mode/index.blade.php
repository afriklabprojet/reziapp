...
@section('title', 'Mode vacances — Rezi Studio Meublé Faya')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('owner.vacation-mode.activate') }}" class="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
        ...
        <div>
            ...
            <div class="space-y-2 mt-2">
                ...
                <label class="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors">
                    <input type="checkbox" name="residence_ids[]" value="{{ $r->id }}" class="rounded border-gray-300 text-[#F16A00] focus:ring-[#F16A00]" {{ in_array($r->id, old('residence_ids', [])) ? 'checked' : '' }}>
        ...
        <div>
            ...
            <input type="text" name="reason" value="{{ old('reason') }}" class="w-full rounded-xl border-gray-200 focus:ring-[#F16A00] focus:border-[#F16A00] text-sm" placeholder="Ex: Voyage en famille">
        </div>
