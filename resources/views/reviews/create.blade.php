                ...
                <form action="{{ route('reviews.store', $residence) }}" method="POST" x-data="reviewForm(@js(['rating_cleanliness' => old('rating_cleanliness', 0), 'rating_location' => old('rating_location', 0), 'rating_value' => old('rating_value', 0), 'rating_communication' => old('rating_communication', 0)]))">
                    ...
                    <div class="mt-6 p-4 bg-orange-50 rounded-xl">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                <span class="text-2xl font-bold text-orange-600" x-text="overallRating.toFixed(1)"></span>
                                <span class="text-orange-600">/5</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="comment" id="comment" rows="5" 
                                  class="w-full border-gray-300 rounded-xl focus:border-orange-500 focus:ring-orange-500"
                    ...
                    <div class="mt-6 flex items-center justify-between pt-6 border-t">
                        ...
                        <button type="submit" 
                                class="inline-flex items-center gap-2 bg-orange-600 text-white px-6 py-3 rounded-xl hover:bg-orange-700 transition-colors"
                                :disabled="!isValid"
