...
<a href="{{ $url }}" style="display: inline-block; text-decoration: none;">
    ...
    <img src="{{ asset('images/logo-rezi.png') }}"
         alt="Rezi App Studio Meublé Faya"
         height="52"
         width="auto"
    ...
    <span style="display: inline-block; vertical-align: middle; margin-left: 10px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 26px; font-weight: 900; color: #f97316; letter-spacing: -1px; line-height: 1;">Rezi App Studio Meublé Faya</span>
</a>
</td>
</tr>
<tr>
