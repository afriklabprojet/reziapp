...
<head>
    ...
    <title>Erreur serveur - Rezi Studio Meublé Faya</title>
...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <a href="{{ route('home') }}" class="mb-8">
            <img loading="lazy" src="{{ asset('images/logo-rezi.png') }}" alt="Rezi Studio Meublé Faya" class="h-12 w-auto">
        </a>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <button onclick="location.reload()" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#F16A00] text-white font-semibold rounded-xl hover:bg-[#CC5A00] transition-colors shadow-lg shadow-none">
