...
<head>
    ...
    <title>Erreur serveur - Rezi App</title>
...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <button onclick="if(document.referrer && document.referrer !== window.location.href){ window.location.href = document.referrer; } else { history.back(); }" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#F16A00] text-white font-semibold rounded-xl hover:bg-[#CC5A00] transition-colors shadow-lg shadow-none">
