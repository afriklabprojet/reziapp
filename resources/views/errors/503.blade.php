...
<head>
    ...
    <title>Maintenance en cours - Rezi Studio Meublé Faya</title>
...
<body class="font-sans antialiased bg-linear-to-br from-[#F16A00] to-[#CC5A00]">
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        {{-- Logo --}}
        <div class="mb-8">
            <img loading="lazy" src="{{ asset('images/logo-rezi.png') }}" alt="Rezi Studio Meublé Faya" class="h-16 w-auto brightness-0 invert">
        </div>
        ...
        <p class="text-[#FFE7D1] text-center max-w-md mb-8 text-lg">
            Nous améliorons Rezi Studio Meublé Faya pour vous offrir une meilleure expérience.
