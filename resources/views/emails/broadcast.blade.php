    ...
    <div class="container">
        <div class="logo">
            <a href="https://reziapp.ci" style="text-decoration:none; display:inline-block;">
                <img src="{{ asset('images/logo-rezi.png') }}" alt="ReziApp" style="height:56px; width:auto; vertical-align:middle; display:inline-block;">
        ...
        <div class="footer">
            <p>Merci de faire confiance à <strong>ReziApp</strong> !</p>
            <p style="color:#6b7280; margin:8px 0;">L'équipe ReziApp</p>
            ...
            <p style="font-size:11px; color:#9ca3af; margin-top:12px;">&copy; {{ date('Y') }} ReziApp &middot; Abidjan, Côte d'Ivoire</p>
        </div>
    </div>
</body>
</html>
