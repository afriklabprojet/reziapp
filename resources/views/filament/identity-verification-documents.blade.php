            ...
            @if($photo['url'])
                <a href="{{ $photo['url'] }}" target="_blank" class="block w-full group">
                    <img
                        ...
                        loading="lazy"
                        onerror="this.parentElement.parentElement.innerHTML='<div class=\'flex h-40 w-full flex-col items-center justify-center rounded-lg border-2 border-dashed border-orange-300 dark:border-orange-700 bg-orange-50 dark:bg-orange-900/20 gap-2\'><svg class=\'w-8 h-8 text-orange-400\' fill=\'none\' stroke=\'currentColor\' viewBox=\'0 0 24 24\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' stroke-width=\'2\' d=\'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z\'></path></svg><p class=\'text-xs text-orange-600 dark:text-orange-400 text-center px-2\'>Fichier non disponible sur ce serveur</p></div>'"
                    >
                </a>
