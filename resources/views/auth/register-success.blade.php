            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                <div class="mb-8">
                    <div class="w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-2xl">
                        <span class="text-3xl font-bold bg-linear-to-r from-orange-500 to-orange-500 bg-clip-text text-transparent">R</span>
                    </div>
                </div>
                ...
                <div class="space-y-4 w-full max-w-sm">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-orange-200 text-sm">Résidences meublées à Abidjan et environs</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center shrink-0 mt-0.5">
                        ...
                        <div>
                            ...
                            <p class="text-orange-200 text-sm">Réservez et payez en ligne en quelques clics</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <div class="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center shrink-0 mt-0.5">
                        ...
                        <div>
                            ...
                            <p class="text-orange-200 text-sm">Notre équipe est disponible pour vous aider</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full max-w-md">
                ...
                @if(session('registration') === 'success')
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 mb-2">
                            Bienvenue, <span class="font-semibold text-orange-500">{{ auth()->user()->name ?? '' }}</span> 👋
                        </p>
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('home') }}"
                                class="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors">
                ...
                @else
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{ route('register') }}"
                            class="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-xl transition-colors">
                            Créer un compte
                        </a>
                    </div>
                @endif
