<x-app-layout>
    @section('title', 'Nouveau mot de passe - REZI')
                ...
                <div class="space-y-4 w-full max-w-sm">
                    <div class="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-orange-100">Plus c'est long, mieux c'est</div>
                        </div>
                    </div>
                    <div class="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4">
                        <div class="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-orange-100">Lettres, chiffres, symboles</div>
                        </div>
                    </div>
                </div>
            </div>
