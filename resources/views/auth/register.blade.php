<x-app-layout>
    ...
    <div class="min-h-[calc(100vh-56px)] md:min-h-[calc(100vh-64px)] flex" x-data="{
        ...
        <div
            class="hidden lg:flex lg:w-1/2 bg-linear-to-br from-orange-500 via-orange-500 to-green-700 relative overflow-hidden">
            {{-- Background Pattern --}}
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                ...
                <div class="space-y-4 w-full max-w-sm">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-orange-100">Aucun frais pour créer votre compte</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-orange-100">Sans intermédiaire ni commission</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-orange-100">Soyez notifié des nouvelles offres</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-orange-100">Sauvegardez vos recherches</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-12 bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-sm">
                    ...
                    <p class="text-sm italic text-orange-50">"J'ai trouvé mon appartement en 2 jours grâce à REZI. La
                    ...
                    <div class="mt-3 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="text-xs text-orange-200">Cocody, Abidjan</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="flex items-center justify-center gap-2 mb-8">
                    ...
                    <div class="w-8 h-0.5 bg-gray-200">
                        <div :class="step >= 2 ? 'bg-orange-500' : 'bg-gray-200'" class="h-full transition-all"
                            :style="step >= 2 ? 'width: 100%' : 'width: 0%'"></div>
                    </div>
                    <div class="flex items-center gap-2">
                        <div :class="step >= 2 ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-500'"
                            class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-colors">
                            2</div>
                        <span class="text-sm font-medium text-gray-600 hidden sm:block">Infos</span>
                    </div>
                    <div class="w-8 h-0.5 bg-gray-200">
                        <div :class="step >= 3 ? 'bg-orange-500' : 'bg-gray-200'" class="h-full transition-all"
                            :style="step >= 3 ? 'width: 100%' : 'width: 0%'"></div>
                    </div>
                    <div class="flex items-center gap-2">
                        <div :class="step >= 3 ? 'bg-orange-500 text-white' : 'bg-gray-200 text-gray-500'"
                            class="w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold transition-colors">
                            3</div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div x-show="step === 1" x-transition:enter="transition ease-out duration-200"
                        ...
                        <div class="space-y-3">
                            ...
                            <label @click="role = 'user'"
                                :class="role === 'user' ? 'border-orange-500 bg-orange-50 ring-2 ring-orange-500' :
                                ...
                                <div :class="role === 'user' ? 'bg-orange-500' : 'bg-gray-100'"
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span x-show="role === 'user'"
                                            class="text-xs bg-orange-100 text-orange-600 px-2 py-0.5 rounded-full font-medium">Sélectionné</span>
                                    </div>
                                    <p class="text-sm text-gray-500 mt-1">Trouvez votre logement meublé idéal en
                                        Afrique de l'Ouest
                                    </p>
                                </div>
                                <div :class="role === 'user' ? 'border-orange-500' : 'border-gray-300'"
                                    class="w-5 h-5 rounded-full border-2 flex items-center justify-center">
                                    <div x-show="role === 'user'" class="w-2.5 h-2.5 bg-orange-500 rounded-full">
                                    </div>
                                </div>
                            </label>
                        ...
                        <div x-show="role === 'owner'" x-transition
                            class="mt-4 p-4 bg-linear-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-100">
                        ...
                        <button type="button" @click="step = 2"
                            class="mt-6 w-full bg-linear-to-r from-orange-500 to-orange-500 hover:from-orange-600 hover:to-teal-700 text-white font-semibold py-3.5 px-4 rounded-xl transition-all shadow-lg shadow-orange-500/30 flex items-center justify-center gap-2">
                            <span>Continuer</span>
                    ...
                    <div x-show="step === 2" x-transition:enter="transition ease-out duration-200"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input id="name" name="name" type="text" x-model="name" required
                                    ...
                                    class="w-full pl-12 pr-4 py-3.5 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all {{ $errors->has('name') ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200' }}">
                            </div>
                            @error('name')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input id="email" name="email" type="email" x-model="email" required
                                    ...
                                    class="w-full pl-12 pr-4 py-3.5 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all {{ $errors->has('email') ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200' }}">
                            </div>
                            @error('email')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="button" @click="step = 3" :disabled="!name || !email"
                                :class="name && email ?
                                    'bg-linear-to-r from-orange-500 to-orange-500 hover:from-orange-600 hover:to-teal-700 shadow-lg shadow-orange-500/30' :
                    ...
                    <div x-show="step === 3" x-transition:enter="transition ease-out duration-200"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input id="password" name="password" :type="showPassword ? 'text' : 'password'"
                                    ...
                                    class="w-full pl-12 pr-12 py-3.5 bg-white border rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all {{ $errors->has('password') ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-200' }}">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <input id="password_confirmation" name="password_confirmation"
                                    ...
                                    class="w-full pl-12 pr-12 py-3.5 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all">
                            ...
                            <label class="flex items-start gap-3 cursor-pointer">
                                ...
                                <span class="text-sm text-gray-600">
                                    J'accepte les <a href="{{ route('pages.cgu') }}"
                                        class="text-orange-500 hover:underline">Conditions d'utilisation</a> et la <a
                                        href="{{ route('pages.confidentialite') }}"
                                        class="text-orange-500 hover:underline">Politique de confidentialité</a>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="submit"
                                class="flex-1 bg-linear-to-r from-orange-500 to-orange-500 hover:from-orange-600 hover:to-teal-700 text-white font-semibold py-3.5 px-4 rounded-xl transition-all shadow-lg shadow-orange-500/30 flex items-center justify-center gap-2">
