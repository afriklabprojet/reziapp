    ...
    <div class="min-h-[calc(100vh-56px)] md:min-h-[calc(100vh-64px)] flex" x-data="{ showPassword: false }">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                ...
                <div class="mb-10 text-center">
                    <div
                        class="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-2xl shadow-orange-500/20 mx-auto mb-4">
                        <span class="text-2xl font-extrabold text-orange-500">R</span>
                    </div>
                ...
                <p class="text-xl text-gray-300 text-center mb-12 max-w-sm leading-relaxed">
                    Trouvez votre <span class="text-orange-400 font-semibold">résidence meublée idéale</span> en
                    quelques clics
                </p>
                ...
                <div class="space-y-3 w-full max-w-sm">
                    <div
                        ...
                        <div class="w-10 h-10 bg-orange-500/20 rounded-xl flex items-center justify-center shrink-0">
                ...
                <div class="mt-12 flex items-center gap-6">
                    <div class="text-center">
                        <div class="text-2xl font-extrabold text-orange-400">500+</div>
        ...
        <div
            ...
            <div class="absolute inset-0 bg-linear-to-b from-gray-50/80 to-white pointer-events-none"
                aria-hidden="true"></div>
            <div class="absolute top-0 right-0 w-64 h-64 bg-orange-50 rounded-full blur-3xl opacity-60 pointer-events-none"
                aria-hidden="true"></div>
            ...
            <div class="w-full max-w-md relative">
                ...
                <div class="lg:hidden text-center mb-8">
                    <div
                        ...
                        <span class="text-lg font-extrabold text-orange-400">R</span>
                    </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email') }}" required
                                ...
                                class="w-full pl-12 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500/40 focus:border-orange-400 focus:bg-white transition-all">
                        </div>
                        @error('email')
                    ...
                    {{-- Submit Button --}}
                    <button type="submit"
                        class="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3.5 px-4 rounded-xl transition-all duration-200 shadow-lg shadow-orange-500/25 hover:shadow-xl hover:shadow-orange-500/30 active:scale-[0.98] flex items-center justify-center gap-2">
                ...
                <div class="mt-6 p-4 bg-gray-900 rounded-2xl text-white">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <a href="{{ route('register') }}"
                                class="text-sm text-orange-400 hover:text-orange-300 font-semibold transition-colors">
