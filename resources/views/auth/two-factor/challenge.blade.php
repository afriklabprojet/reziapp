            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="text-center mb-5">
                        <div
                            class="w-16 h-16 rounded-full bg-orange-50 flex items-center justify-center mx-auto mb-4 animate-pulse-slow">
                            <svg class="w-8 h-8 text-orange-600" fill="none" stroke="currentColor" stroke-width="1.5"
                                viewBox="0 0 24 24">
                    ...
                    <div class="mt-3 text-center">
                        <p class="text-[11px] text-gray-400">
                            ...
                            <a href="{{ route('pages.contact') }}"
                                class="text-orange-600 hover:text-orange-700 font-medium">Contacter le support</a>
                        </p>
                    </div>
                </div>
            </div>
