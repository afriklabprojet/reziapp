...
@section('title', 'Codes de récupération - Rezi Studio Meublé Faya')
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="p-5 sm:p-6">
                ...
                <div class="flex gap-2 mt-4" x-data="{ copiedAll: false }">
                    ...
                    <a href="data:text/plain;charset=utf-8,{{ urlencode("Rezi Studio Meublé Faya - Codes de récupération 2FA\n" . str_repeat('=', 35) . "\n\n" . implode("\n", array_map(fn($c, $i) => ($i+1) . '. ' . $c, $codes, array_keys($codes))) . "\n\nChaque code ne peut être utilisé qu'une seule fois.\nGardez-les dans un endroit sûr.") }}"
    ...
    <script>
        function printCodes() {
            ...
            printWindow.document.write(`
                <html><head><title>Rezi Studio Meublé Faya - Codes de récupération 2FA</title>
                <style>
                ...
                <h1>🔐 Rezi Studio Meublé Faya - Codes de récupération</h1>
