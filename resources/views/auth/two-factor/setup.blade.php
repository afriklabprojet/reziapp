...
@section('title', 'Double authentification - REZI')
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div class="p-5 sm:p-6">
                    ...
                    <div class="text-center mb-6">
                        <div class="w-14 h-14 rounded-full bg-[#fff0f3] flex items-center justify-center mx-auto mb-3">
                            <svg class="w-7 h-7 text-[#e00b41]" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">Liez votre compte REZI à l'application</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3 p-3 rounded-xl hover:bg-gray-50 transition-colors">
                            <div class="shrink-0 w-8 h-8 rounded-full bg-gray-900 flex items-center justify-center">
