<x-app-layout>
    @section('title', $metaTitle ?? $content['title'] ?? "Conditions Générales d'Utilisation")
    @section('description', $metaDescription ?? "Conditions générales d'utilisation de la plateforme Rezi Studio Meublé Faya.")
        ...
        <div class="bg-white border-b border-gray-200">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <nav class="text-sm text-gray-500 mb-4">
                    <a href="{{ route('home') }}" class="hover:text-[#F16A00] transition">Accueil</a>
                    <span class="mx-2">›</span>
                    <span class="text-gray-900">Conditions d'utilisation</span>
                </nav>
                <h1 class="text-3xl sm:text-4xl font-bold text-gray-900">{{ $content['title'] ?? "Conditions Générales d'Utilisation" }}</h1>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-8 sm:p-12 space-y-8">
                ...
                <section>
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        ...
                        <a href="mailto:{{ config('rezi.company.email') }}" class="text-[#F16A00] hover:underline">{{ config('rezi.company.email') }}</a>
                    </p>
                </section>
