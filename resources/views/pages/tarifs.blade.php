<x-app-layout>
    ...
    {{-- HERO TARIFS --}}
    <section class="relative bg-linear-to-br from-gray-900 via-gray-900 to-orange-950 text-white overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-24 text-center">
            ...
            <h1 class="font-display text-4xl sm:text-5xl font-extrabold mb-4">
                Un modèle simple,<br>
                <span class="text-orange-400">transparent et juste</span>
            </h1>
    ...
    <section class="py-16 sm:py-24 bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-12">
                <h2 class="font-display text-3xl sm:text-4xl font-extrabold text-gray-900">Pour qui, combien ?</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {{-- PROPRIÉTAIRES --}}
                <div class="relative bg-linear-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-3xl p-8">
                    <div class="absolute top-4 right-4 bg-orange-500 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow">
                        ⭐ Recommandé
                    </div>
                    <div class="w-14 h-14 bg-orange-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-orange-500/25">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                    </div>
                    <div class="inline-block bg-orange-100 text-orange-700 text-xs font-bold px-3 py-1 rounded-full mb-4">PROPRIÉTAIRES</div>
                    <div class="flex items-end gap-2 mb-2">
                        <span class="text-5xl font-extrabold text-gray-900">0</span>
                        <span class="text-xl font-bold text-gray-500 mb-2">FCFA</span>
                    </div>
                    ...
                    <ul class="space-y-3">
                        @foreach([
                            ...
                            'Support prioritaire équipe REZI',
                        ] as $item)
                        <li class="flex items-center gap-3 text-sm text-gray-700">
                            <svg class="w-4 h-4 text-green-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7" />
                    ...
                    <div class="mt-8">
                        <a href="{{ route('owner.residences.create') }}"
                            class="block w-full text-center py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl transition-colors shadow-lg shadow-orange-500/25">
    ...
    {{-- COMPARAISON REZI vs AGENCES --}}
    <section class="py-16 sm:py-20 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-10">
                <h2 class="font-display text-3xl font-extrabold text-gray-900">REZI vs les agences immobilières</h2>
                <p class="mt-2 text-gray-500">Pourquoi choisir REZI vous fait économiser des centaines de milliers de FCFA</p>
            </div>
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr class="bg-gray-50 border-b border-gray-200">
                            ...
                            <th class="px-6 py-4 text-center font-bold text-orange-600">REZI</th>
    ...
    {{-- CTA FINAL --}}
    <section class="py-16 sm:py-20 bg-linear-to-br from-orange-500 to-orange-600">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 text-center text-white">
            <h2 class="font-display text-3xl sm:text-4xl font-extrabold mb-4">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('owner.residences.create') }}"
                    class="inline-flex items-center justify-center gap-2 bg-white text-orange-600 hover:bg-orange-50 px-8 py-4 rounded-2xl font-bold text-base shadow-xl transition-all hover:scale-105">
                ...
                <a href="{{ route('residences.index') }}"
                    class="inline-flex items-center justify-center gap-2 bg-orange-600/50 hover:bg-orange-600/70 text-white border border-white/30 px-8 py-4 rounded-2xl font-bold text-base transition-all">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
