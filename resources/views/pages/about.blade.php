    ...
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
                <div class="max-w-3xl">
                    <nav class="text-sm text-gray-400 mb-6" aria-label="Breadcrumb">
                        ...
                        <span class="text-orange-400">À propos</span>
                    </nav>
                    ...
                    <div class="mt-8 flex flex-wrap gap-3">
                        <a href="{{ route('residences.index') }}"
                            class="inline-flex items-center gap-2 px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-xl font-semibold transition-all shadow-lg shadow-orange-500/25 active:scale-95">
                ...
                <div class="grid md:grid-cols-3 gap-8 lg:gap-12">
                    @foreach ($steps['items'] ?? [] as $i => $step)
                        ...
                        <div class="relative text-center">
                            <div
                                class="absolute -top-3 left-1/2 -translate-x-1/2 w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-lg shadow-orange-200 z-10">
                                {{ $i + 1 }}</div>
                            <div
        ...
        <section class="py-16 sm:py-24">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-14">
                    <div
                        class="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-4">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
        ...
        <section class="bg-white py-16 sm:py-24">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="relative">
                        <div class="bg-linear-to-br from-orange-50 to-orange-100 rounded-3xl p-8 sm:p-12">
                            <div class="space-y-4">
                                <div class="bg-white rounded-2xl shadow-md p-4 flex gap-4 items-center">
                                    <div
                                        class="w-16 h-16 bg-orange-200 rounded-xl shrink-0 flex items-center justify-center">
        ...
        <section class="py-16 sm:py-24">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    ...
                    <div class="absolute bottom-0 left-0 w-48 h-48 bg-orange-500/10 rounded-full blur-3xl"
                        aria-hidden="true"></div>
