            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div class="max-w-3xl">
                    <nav class="text-sm text-gray-400 mb-6" aria-label="Breadcrumb">
                        ...
                        <span class="text-[#FF8A1F]">Nous contacter</span>
                    </nav>
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                    ...
                    <a href="mailto:{{ $cards['email'] ?? config('rezi.company.email') }}"
                        ...
                        <div
                            class="w-12 h-12 bg-[#FFE7D1] rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#F16A00] transition-colors">
                            <svg class="w-6 h-6 text-[#F16A00] group-hover:text-white transition-colors" fill="none"
                        ...
                        <p class="text-[#F16A00] text-sm font-medium group-hover:underline">
            ...
            <div class="grid lg:grid-cols-5 gap-12 lg:gap-16">
                ...
                <div class="lg:col-span-2">
                    ...
                    <a href="{{ route('pages.faq') }}"
                        class="inline-flex items-center gap-2 text-[#F16A00] font-semibold hover:text-[#CC5A00] transition group">
                        Voir toute la FAQ
                ...
                <div class="lg:col-span-3 space-y-3" x-data="{ open: 1 }">
                    @foreach ($faq['items'] ?? [] as $i => $faqItem)
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden transition-shadow"
                            :class="open === {{ $i + 1 }} ? 'shadow-md border-[#FFD0A3]' : ''">
                            <button class="w-full flex items-center justify-between p-5 sm:p-6 text-left gap-4"
                                ...
                                <span
                                    ...
                                    :class="open === {{ $i + 1 }} ? 'bg-[#F16A00] text-white' :
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div class="bg-gray-50 rounded-3xl p-8 sm:p-10">
                        ...
                        @if (!empty($hours['note']))
                            <div class="mt-6 p-4 bg-[#FFF4EB] rounded-xl border border-[#FFE7D1]">
                                <div class="flex gap-3">
                                    <svg class="w-5 h-5 text-[#F16A00] shrink-0 mt-0.5" fill="currentColor"
                                        viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z"
                                            clip-rule="evenodd" />
                                    </svg>
                                    <p class="text-sm text-[#A34700]">{{ $hours['note'] }}</p>
                                </div>
                            </div>
                        @endif
                    </div>
