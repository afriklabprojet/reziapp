<x-app-layout>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        {{-- ===== Hero ===== --}}
        <div class="bg-linear-to-br from-orange-500 via-orange-500 to-orange-600">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <nav class="text-sm text-orange-100 mb-4 flex items-center gap-1.5">
                ...
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
                    <div>
                        ...
                        <p class="mt-3 text-orange-100 text-lg max-w-xl">{{ $content['subtitle'] ?? "Tout ce que vous devez savoir pour réussir sur REZI" }}</p>
                    </div>
                ...
                <div class="mt-10 grid grid-cols-3 gap-4">
                    <div class="bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center">
                        ...
                        <div class="text-xs text-orange-100 mt-0.5">Publication gratuite</div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center">
                        <div class="text-2xl font-bold text-white">0%</div>
                        <div class="text-xs text-orange-100 mt-0.5">Commission REZI</div>
                    </div>
                    <div class="bg-white/15 backdrop-blur-sm rounded-2xl p-4 text-center">
                        <div class="text-2xl font-bold text-white">24h</div>
                        <div class="text-xs text-orange-100 mt-0.5">Délai modération</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
            <div class="bg-orange-50 border border-orange-100 rounded-2xl p-5">
                <p class="text-xs font-semibold text-orange-700 uppercase tracking-wider mb-3">Sommaire</p>
                <div class="grid sm:grid-cols-2 gap-x-6 gap-y-1.5">
                    @foreach($content['steps'] as $i => $step)
                    <a href="#step-{{ $i + 1 }}" class="flex items-center gap-2 text-sm text-orange-800 hover:text-orange-600 transition group">
                        <span class="w-5 h-5 bg-orange-200 rounded-full flex items-center justify-center text-xs font-bold text-orange-700 shrink-0 group-hover:bg-orange-300 transition">{{ $i + 1 }}</span>
                        {{ $step['title'] }}
                    </a>
                    @endforeach
                </div>
                    ...
                    <div class="bg-linear-to-r from-orange-500 to-orange-600 p-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-orange-100 mt-1 text-sm leading-relaxed">{{ $step['description'] }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <div class="flex items-start gap-3">
                                <span class="shrink-0 w-6 h-6 bg-orange-100 text-orange-700 rounded-full flex items-center justify-center text-xs font-bold mt-0.5">{{ $idx + 1 }}</span>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
            <div class="bg-linear-to-br from-orange-500 to-orange-600 rounded-2xl p-8 sm:p-10 text-center">
                ...
                <p class="text-orange-100 mb-8 max-w-md mx-auto">Publication gratuite, sans commission. Rejoignez les propriétaires qui font confiance à REZI.</p>
                <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                    @auth
                    <a href="{{ route('owner.residences.create') }}"
                        class="inline-flex items-center gap-2 px-6 py-3 bg-white text-orange-600 font-semibold rounded-xl hover:bg-orange-50 transition shadow-sm">
