    ...
    <div class="max-w-lg w-full">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 text-center">
            ...
            <p class="text-gray-600 mb-8">
                Votre paiement de <span class="font-semibold text-[#CC5A00]">{{ $payment->formatted_total }}</span> a été effectué avec succès.
            </p>
            ...
            <div class="bg-[#FFF4EB] rounded-xl p-6 mb-8 text-left">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a href="{{ route('bookings.show', $payment->booking) }}" 
                   class="flex-1 inline-flex items-center justify-center px-4 py-3 bg-[#CC5A00] text-white rounded-lg hover:bg-[#A34700] font-medium transition-colors">
                    Voir ma réservation
