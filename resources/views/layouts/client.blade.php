    ...
    <nav class="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 lg:hidden safe-bottom">
        <div class="grid grid-cols-5 h-16">
            ...
            <a href="{{ route('client.dashboard') }}"
                class="flex flex-col items-center justify-center gap-0.5 text-xs transition {{ Str::startsWith($navRoute, 'client.dashboard') ? 'text-[#F16A00]' : 'text-gray-500 hover:text-gray-700' }}">
            ...
            <a href="{{ route('residences.index') }}"
                class="flex flex-col items-center justify-center gap-0.5 text-xs transition {{ Str::startsWith($navRoute, 'residences') ? 'text-[#F16A00]' : 'text-gray-500 hover:text-gray-700' }}">
            ...
            <a href="{{ route('bookings.index') }}"
                class="flex flex-col items-center justify-center gap-0.5 text-xs transition {{ Str::startsWith($navRoute, 'bookings') ? 'text-[#F16A00]' : 'text-gray-500 hover:text-gray-700' }}">
            ...
            <a href="{{ route('chat.index') }}"
                class="flex flex-col items-center justify-center gap-0.5 text-xs transition {{ Str::startsWith($navRoute, 'chat') ? 'text-[#F16A00]' : 'text-gray-500 hover:text-gray-700' }}">
            ...
            <a href="{{ route('profile.edit') }}"
                class="flex flex-col items-center justify-center gap-0.5 text-xs transition {{ Str::startsWith($navRoute, 'profile') ? 'text-[#F16A00]' : 'text-gray-500 hover:text-gray-700' }}">
