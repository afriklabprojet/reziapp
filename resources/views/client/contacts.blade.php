...
@section('title', 'Mes demandes de contact - Rezi Studio Meublé Faya')
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-[#F16A00]">{{ $contactStats['replied'] }}</p>
    ...
    <div class="flex flex-wrap gap-2 mb-6">
        @if (!request('status'))
            <a href="{{ route('client.contacts') }}"
                class="px-4 py-2 rounded-full text-sm font-medium transition bg-[#F16A00] text-white">
                Toutes
            </a>
        @else
            <a href="{{ route('client.contacts') }}"
                ...
                <div
                    ...
                    <div class="flex flex-col sm:flex-row">
                        ...
                        <div class="flex-1 p-5">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2 mb-2">
                                        ...
                                        @elseif($contact->status == 'replied')
                                            <span
                                                class="px-2 py-1 bg-[#FFE7D1] text-[#CC5A00] text-xs font-medium rounded-full">Répondue</span>
                                        @else
                                            <span
                                ...
                                <div class="text-right shrink-0">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="w-10 h-10 rounded-full overflow-hidden bg-gray-200">
                                            ...
                                            @else
                                                <div class="w-full h-full flex items-center justify-center bg-[#FFE7D1]">
                                                    <span
                                                        class="text-sm font-medium text-[#F16A00]">{{ substr($contact->owner->name, 0, 1) }}</span>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                            ...
                            @if ($contact->reply)
                                <div class="mt-3 p-3 bg-[#FFF4EB] rounded-lg border-l-4 border-[#F16A00]">
                                    <p class="text-xs text-[#F16A00] font-medium mb-1">Réponse du propriétaire</p>
