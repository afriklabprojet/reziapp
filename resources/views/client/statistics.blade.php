...
@section('title', 'Mes statistiques - ReziApp')
...
@section('client-content')
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600">Analysez votre activité sur ReziApp</p>
    </div>

    {{-- Infos membre --}}
    <div class="bg-gradient-to-r from-[#F16A00] to-[#CC5A00] rounded-xl p-6 text-white mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-[#FFE7D1]">Membre depuis {{ $globalStats['member_since']->translatedFormat('d F Y') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100 text-center">
            <div class="w-10 h-10 bg-[#FFE7D1] rounded-lg flex items-center justify-center mx-auto mb-2">
                    ...
                    @foreach ($topCommunes as $index => $commune)
                        ...
                        <div>
                            ...
                            <div class="h-2 bg-gray-100 rounded-full overflow-hidden">
                                <div class="h-full bg-[#F16A00] rounded-full transition-all"
    ...
    <div class="mt-8 bg-gradient-to-br from-[#FFF4EB] to-amber-50 rounded-xl p-6 border border-[#FFE7D1]">
