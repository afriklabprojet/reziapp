...
@section('title', 'Mon Espace - Rezi Studio Meublé Faya')
        ...
        <div x-show="loaded" x-transition:enter="transition ease-out duration-300"
            ...
            @if ($reviewsAwaitingFeedback > 0)
                <div class="flex items-center gap-4 bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-amber-700 mt-0.5">Partagez votre expérience — votre avis aide la communauté Rezi Studio Meublé Faya</p>
                    </div>
            ...
            @if (
                ...
                <div
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-2">Bienvenue sur Rezi Studio Meublé Faya ! 🎉</h2>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                {{-- Récapitulatif activité Rezi Studio Meublé Faya --}}
                    @if ($activityStats['stays'] > 0)
                        <div class="bg-gradient-to-br from-[#FFF4EB] to-amber-50 rounded-xl border border-[#FFE7D1] p-5">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <h3 class="font-semibold text-gray-900">Votre parcours Rezi Studio Meublé Faya</h3>
                            </div>
                    ...
                    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#F16A00] to-amber-500 p-8 text-white shadow-lg">
                        ...
                        <div class="relative flex flex-col sm:flex-row items-center justify-between gap-6">
                            <div>
                                ...
                                <p class="text-white/80">Rejoignez les propriétaires Rezi Studio Meublé Faya et commencez à générer des revenus dès maintenant.</p>
                            </div>
