...
@section('title', 'Mes alertes - Rezi App')
                            ...
                            <div class="flex items-center justify-between p-4">
                                ...
                                <div class="flex items-center gap-2 shrink-0">
                                    ...
                                    <form action="{{ route('client.alerts.delete', $savedSearch) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="p-1.5 text-gray-400 hover:text-red-500 transition rounded-lg hover:bg-red-50" title="Supprimer cette alerte"  data-confirm='Supprimer cette alerte ?'>
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
