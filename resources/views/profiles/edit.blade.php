...
@section('client-content')
    ...
    <form action="{{ route('profile.public.update') }}" method="POST" class="space-y-6">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <div x-data="{ chars: {{ strlen($profile->bio ?? '') }} }">
                        <textarea id="bio" name="bio" rows="4" x-on:input="chars = $event.target.value.length" maxlength="1000"
                            class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition resize-none"
                        ...
                        <div class="flex justify-between items-center mt-1">
                            ...
                            <span class="text-xs" :class="chars > 900 ? 'text-orange-500' : 'text-gray-400'">
                ...
                <div>
                    ...
                    <input type="text" id="location" name="location" value="{{ old('location', $profile->location) }}"
                        class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition"
            ...
            <div class="p-6" x-data="{
                    ...
                    <template x-for="(lang, index) in languages" :key="index">
                        <span
                            ...
                            <button type="button" @click="removeLanguage(lang)"
                                class="ml-1 hover:text-orange-900 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex items-center gap-2 mb-4">
                    <input type="text" x-model="newLang" @keydown.enter.prevent="addLanguage()"
                        class="flex-1 px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                        placeholder="Tapez une langue...">
                    <button type="button" @click="addLanguage()"
                        class="px-4 py-2.5 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-sm font-medium transition">
                        Ajouter
                    </button>
                </div>
        ...
        <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-4 pt-4">
            ...
            <button type="submit"
                class="w-full sm:w-auto px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white font-medium rounded-lg shadow-sm hover:shadow transition flex items-center justify-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
