...
<div class="max-w-4xl mx-auto px-4 py-8">
    <a href="{{ route('profile.show', $user) }}" class="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-6">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border p-6">
            <div class="flex items-start justify-between mb-3">
                <div>
                    @if($review->residence)
                    <a href="{{ route('residences.show', $review->residence) }}" class="font-medium text-gray-900 hover:text-orange-600">{{ $review->residence->title }}</a>
                    @endif
