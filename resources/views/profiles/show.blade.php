...
@section('content')
    <div class="min-h-screen bg-linear-to-br from-gray-50 via-white to-orange-50/30">
        <!-- Hero Header -->
        <div class="relative">
            <!-- Fond avec motif -->
            <div class="absolute inset-0 bg-linear-to-r from-orange-500 via-orange-400 to-amber-500 h-64 sm:h-80">
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-end gap-6">
                    ...
                    <div class="flex-1 text-center sm:text-left text-white">
                        ...
                        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-3">
                            @auth
                                @if (Auth::id() === $user->id)
                                    <a href="{{ route('profile.edit') }}"
                                        class="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-orange-600 hover:bg-orange-50 rounded-xl font-medium shadow-lg shadow-orange-900/20 transition-all hover:scale-105">
                            ...
                            @else
                                <a href="{{ route('login') }}"
                                    class="inline-flex items-center gap-2 px-6 py-3 bg-white text-orange-600 hover:bg-orange-50 rounded-xl font-semibold shadow-lg transition-all hover:scale-105">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-12 relative z-10">
            ...
            @if ($user->isOwner())
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                    ...
                    <div
                        class="bg-white rounded-2xl shadow-lg shadow-gray-200/50 p-5 text-center hover:shadow-xl transition-shadow">
                        <div class="text-2xl font-bold text-orange-500 mb-2">{{ $profile->response_rate_formatted }}</div>
                        ...
                        @foreach ($badges as $badge)
                            @php
                                $badgeStyles = [
                                    ...
                                    'orange' =>
                                        'bg-linear-to-br from-orange-50 to-amber-100 text-orange-800 border-orange-200 shadow-orange-100',
                                    'teal' =>
                        ...
                        <div class="space-y-4">
                            ...
                            @if ($profile->show_email && $user->email)
                                <a href="mailto:{{ $user->email }}"
                                    class="flex items-center gap-3 p-3 bg-orange-50 rounded-xl hover:bg-orange-100 transition group">
                                    <div class="p-2 bg-white rounded-lg shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-orange-600 font-medium group-hover:underline">{{ $user->email }}
                                        </p>
                                    </div>
                                </a>
                            @endif
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <div class="w-full bg-gray-100 rounded-full h-3 overflow-hidden">
                                        <div class="h-full rounded-full transition-all duration-500 {{ $profile->response_rate >= 90 ? 'bg-linear-to-r from-green-400 to-emerald-500' : ($profile->response_rate >= 70 ? 'bg-linear-to-r from-yellow-400 to-orange-500' : 'bg-linear-to-r from-red-400 to-red-500') }}"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    @foreach ($residences as $residence)
                                        <a href="{{ route('residences.show', $residence) }}" class="group block">
                                            ...
                                            <h3
                                                class="font-semibold text-gray-900 group-hover:text-orange-500 transition mb-1">
                                                {{ $residence->title }}</h3>
