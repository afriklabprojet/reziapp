                        ...
                        <div class="flex flex-wrap items-center justify-center sm:justify-start gap-3">
                            @auth
                                ...
                                @else
                                    ...
                                    @endif
                                    <button
                                        onclick="navigator.share ? navigator.share({title: '{{ $user->name }} sur Rezi Studio Meublé Faya', url: window.location.href}) : navigator.clipboard.writeText(window.location.href).then(() => alert('Lien copié!'))"
