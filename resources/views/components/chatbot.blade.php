{{--
    Chatbot IA Rezi App — widget flottant 24/7
    Usage : <x-chatbot />
...
>
    ...
    >
        ...
        <div class="flex items-center gap-3 px-4 py-3 bg-[#F16A00] text-white rounded-t-2xl">
            ...
            <div class="flex-1 min-w-0">
                <p class="font-semibold text-sm leading-tight">Assistant Rezi App</p>
    ...
    >
        ...
        <span class="text-sm font-semibold" x-show="!open">Assistant Rezi App</span>
