...
<div class="group bg-white rounded-2xl shadow-md overflow-hidden card-lift border border-gray-100 hover:border-orange-100">
    ...
    <div class="p-3 sm:p-4">
        ...
        <a href="{{ route('residences.show', $residence) }}"
            class="block w-full text-center py-2.5 rounded-xl font-semibold text-sm bg-orange-500 hover:bg-orange-600 text-white transition-colors shadow-sm shadow-orange-200">
            Voir les détails
        </a>
    </div>
</div>
