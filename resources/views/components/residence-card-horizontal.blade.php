        ...
        <a href="{{ route('residences.show', $residence) }}" class="relative md:w-80 lg:w-96 shrink-0">
            ...
            <div class="absolute top-3 left-3 flex flex-wrap gap-2">
                ...
                @if ($residence->is_featured ?? false)
                    <span class="px-2 py-1 bg-[#F16A00] text-white text-xs font-semibold rounded-lg">En vedette</span>
                @endif
        ...
        <div class="grow p-5 flex flex-col">
            ...
            <div class="flex items-start justify-between mb-3">
                <div>
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 group-hover:text-[#CC5A00] transition-colors">
            ...
            @if ($residence->amenities && $residence->amenities->count() > 0)
                <div class="flex flex-wrap gap-2 mb-4">
                    ...
                    @if ($residence->amenities->count() > 4)
                        <span class="text-xs text-[#CC5A00] px-2 py-1">
            ...
            <div class="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                ...
                <a href="{{ route('residences.show', $residence) }}"
                    class="px-5 py-2.5 bg-[#F16A00] text-white font-medium rounded-xl hover:bg-[#CC5A00] transition-colors">
                    Voir les détails
                </a>
            </div>
        </div>
