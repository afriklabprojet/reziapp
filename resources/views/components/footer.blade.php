        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6" x-data="{
                ...
                <div class="text-center md:text-left">
                    <h3
                        class="text-xl sm:text-2xl font-bold text-white flex items-center justify-center md:justify-start gap-2">
                    ...
                    <p class="text-orange-100 mt-1 text-sm sm:text-base">Recevez les nouvelles résidences et offres
                        exclusives directement dans votre boîte mail.</p>
                </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div class="col-span-2 md:col-span-3 lg:col-span-4">
                ...
                <p class="text-sm leading-relaxed max-w-sm mb-6">
                    La plateforme de référence pour trouver votre résidence meublée en Afrique de l'Ouest. Des centaines
                    de
                    logements vérifiés à portée de clic.
                </p>
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <div>
                            <span class="flex items-center gap-2">
                                ...
                                <span class="text-green-400 text-xs font-medium">Support en ligne 24/7</span>
                            </span>
                        </div>
                    </li>
                </ul>
