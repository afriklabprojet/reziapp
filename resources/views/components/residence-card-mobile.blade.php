...
<div x-data="{
    ...
    <a href="{{ route('residences.show', $residence) }}" class="block relative aspect-4/3 overflow-hidden"
       ...
       ">
        ...
        @else
            <div class="w-full h-full bg-linear-to-br from-orange-100 to-orange-200 flex items-center justify-center">
                <svg aria-hidden="true" class="w-12 h-12 text-orange-300" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
        ...
        @elseif ($residence->is_top_residence)
            <span
                class="absolute top-3 left-3 px-2 py-1 bg-linear-to-r from-orange-500 to-orange-600 text-white text-xs font-medium rounded-full shadow-lg">
                ⭐ Premium
            </span>
        @endif
        ...
        <div class="flex items-start justify-between gap-2">
            ...
            @if ($residence->average_rating)
                <div class="flex items-center gap-1 shrink-0">
                    <svg aria-hidden="true" class="w-4 h-4 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
                        <path
