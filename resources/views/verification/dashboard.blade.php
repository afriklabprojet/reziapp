...
@section('title', 'Centre de Vérification - REZI')
                                ...
                                @if (!$phoneVerified)
                                    ...
                                    @else
                                        <a href="{{ route('profile.edit') }}"
                                            class="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-[#e00b41] hover:text-[#b5083a] transition-colors">
                                            Ajouter un numéro
                ...
                <div class="p-5 sm:p-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <a href="{{ route('verification.emergency.contacts') }}"
                                class="inline-flex items-center gap-1.5 text-sm font-semibold text-[#e00b41] hover:text-[#b5083a]">
                                Ajouter un contact
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    <div class="p-5 sm:p-6">
                        ...
                        <div class="grid gap-3 sm:grid-cols-2">
                            ...
                            <div class="flex items-start gap-3">
                                <div class="shrink-0 w-8 h-8 rounded-lg bg-[#fff0f3] flex items-center justify-center">
