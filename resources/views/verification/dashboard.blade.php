                                ...
                                @if (!$phoneVerified)
                                    ...
                                    @else
                                        <a href="{{ route('profile.edit') }}"
                                            class="mt-3 inline-flex items-center gap-1.5 text-sm font-semibold text-orange-600 hover:text-orange-700 transition-colors">
                                            Ajouter un numéro
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                    <div class="p-5 sm:p-6">
                        ...
                        <div class="grid gap-3 sm:grid-cols-2">
                            ...
                            <div class="flex items-start gap-3">
                                <div class="shrink-0 w-8 h-8 rounded-lg bg-orange-50 flex items-center justify-center">
