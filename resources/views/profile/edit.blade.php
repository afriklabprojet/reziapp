...
@section('client-content')
            ...
            <form method="post" action="{{ route('profile.update') }}" class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $user->name) }}" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition">
                    @error('name')
                ...
                <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                    <button type="submit"
                        class="px-6 py-2.5 bg-orange-500 text-white font-medium rounded-lg hover:bg-orange-600 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition">
                        Enregistrer
                    </button>
    ...
    <div class="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <a href="{{ route('notifications.preferences') }}"
            class="group bg-white rounded-xl border border-gray-100 p-5 hover:border-orange-200 hover:shadow-md transition-all">
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    <h3 class="font-semibold text-gray-900 group-hover:text-orange-600 transition">Notifications</h3>
                    <p class="text-sm text-gray-500">Gérer vos préférences</p>
                </div>
                <svg class="w-5 h-5 text-gray-400 group-hover:text-orange-500 transition" fill="none"
        ...
        <a href="{{ route('profile.public.edit') }}"
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex-1">
                    <h3 class="font-semibold text-gray-900 group-hover:text-orange-600 transition">Profil public</h3>
        ...
        @if ($user->referral_code && Route::has('client.referral'))
            <a href="{{ route('client.referral') }}"
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-semibold text-gray-900 group-hover:text-orange-600 transition">Parrainage</h3>
        ...
        @if ($user->role === 'user' && Route::has('owner.become'))
            <a href="{{ route('owner.become') }}"
                class="group bg-linear-to-br from-orange-50 to-orange-100 rounded-xl border border-orange-200 p-5 hover:shadow-md transition-all">
                <div class="flex items-center gap-4">
                    <div
                        class="w-12 h-12 bg-orange-200 rounded-xl flex items-center justify-center group-hover:bg-orange-300 transition">
                    ...
                    <div class="flex-1">
                        <h3 class="font-semibold text-gray-900 group-hover:text-orange-600 transition">Devenir propriétaire
                        </h3>
