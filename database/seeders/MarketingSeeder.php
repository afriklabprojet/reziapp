    ...
    private function seedCampaigns($admin): void
    {
        $campaigns = [
            ...
            [
                ...
                'type'               => 'email',
                'subject'            => '🏠 Découvrez les nouvelles résidences ReziApp !',
                'content'            => '<h2>Bonjour,</h2><p>De nouvelles résidences viennent d\'être ajoutées sur ReziApp. Découvrez-les dès maintenant et profitez de nos offres exclusives.</p>',
                'audience'           => 'all_users',
                'status'             => 'sent',
            ...
            [
                ...
                'type'               => 'email',
                'subject'            => '🚀 Boostez votre résidence avec la Mise en avant ReziApp',
                'content'            => '<h2>Propriétaire ReziApp,</h2><p>Augmentez votre visibilité et vos réservations grâce à notre nouvelle fonctionnalité Mise en avant.</p>',
                'audience'           => 'owners',
                'status'             => 'sent',
                'recipients_count'   => 5,
                'delivered_count'    => 5,
            ...
            [
                ...
                'type'               => 'email',
                'subject'            => '🌟 Les meilleures offres ReziApp en mai 2026',
            ...
            [
                ...
                'description'        => 'Email de bienvenue avec guide d\'utilisation ReziApp.',
                'type'               => 'email',
                'subject'            => '👋 Bienvenue sur ReziApp — Comment commencer ?',
                'content'            => '<h2>Bienvenue !</h2><p>Voici comment trouver votre premier logement sur ReziApp en 3 étapes simples.</p>',
                'audience'           => 'new_users',
                'status'             => 'draft',
                'recipients_count'   => 0,
                'delivered_count'    => 0,
