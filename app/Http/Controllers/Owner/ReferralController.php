...
class ReferralController extends Controller
{
    ...
    public function share(Request $request)
    {
        ...
        $message = "Rejoins REZI et trouve ta résidence meublée idéale ! Utilise mon code {$user->referral_code} pour bénéficier d'une remise. {$referralUrl}";
        ...
        switch ($channel) {
            ...
            case 'email':
                return redirect('mailto:?subject=Rejoins REZI !&body='.urlencode($message));
            default:
