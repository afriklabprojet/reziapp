...
class ReferralController extends Controller
{
    ...
    public function share(Request $request)
    {
        ...
        $message = "Rejoins Rezi App et trouve ta résidence meublée idéale ! Utilise mon code {$user->referral_code} pour bénéficier d'une remise. {$referralUrl}";
        ...
        switch ($channel) {
            ...
            case 'email':
                return redirect('mailto:?subject=Rejoins Rezi App !&body='.urlencode($message));
            default:
