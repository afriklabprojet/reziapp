...
class NewsletterController extends Controller
{
    ...
    private function dispatchWelcomeEmail(
        ...
        try {
            ...
            $subject = $isReturn
                ? 'Bon retour dans la newsletter Rezi Studio Meublé Faya ! 🎉'
                : 'Bienvenue — vous êtes maintenant insider Rezi Studio Meublé Faya 🏠';
    ...
    private function buildWelcomeEmailHtml(
        ...
        $intro = $isReturn
            ...
            : 'Merci de rejoindre la communauté Rezi Studio Meublé Faya. Vous serez parmi les premiers à recevoir nos nouvelles annonces et promotions exclusives.';
...
<head>
  ...
  <title>Bienvenue sur Rezi Studio Meublé Faya</title>
</head>
            ...
            <tr>
              <td>
                <span style="display:inline-block;background:rgba(255,255,255,0.2);border-radius:10px;padding:6px 16px;">
                  <span style="color:#fff;font-size:20px;font-weight:800;letter-spacing:-0.5px;">Rezi Studio Meublé Faya</span>
                </span>
              </td>
