...
class WhatsAppWebhookController extends Controller
{
    ...
    protected function sendWelcomeMessage(string $phone, ?string $name): void
    {
        ...
        $message = "{$greeting}\n\nMerci de contacter Rezi App, votre plateforme de location de résidences meublées à Abidjan.\n\n🏠 Créez votre compte gratuitement :\nhttps://reziapp.ci/register\n\n✨ Avantages :\n• Accès à +500 résidences\n• Réservation en ligne\n• Paiement sécurisé\n• Support 7j/7\n\nÀ bientôt sur Rezi App !";
