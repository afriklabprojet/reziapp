...
class PageContent extends Model
{
    ...
    public static function defaultAboutData(): array
    {
        return [
            'hero' => [
                ...
                'description' => "Rezi App est la plateforme de référence pour la recherche géolocalisée de résidences meublées en Côte d'Ivoire. Notre mission : rendre la recherche de logement simple, transparente et accessible à tous.",
            ...
            'mission' => [
                ...
                'paragraphs' => [
                    ...
                    "Rezi App est né de cette frustration. Nous avons créé une plateforme qui met la technologie au service de la recherche immobilière, avec des outils de géolocalisation avancés, des photos vérifiées et un système d'avis transparent.",
                    'Que vous soyez un expatrié, un professionnel en déplacement ou un étudiant, Rezi App vous accompagne pour trouver le logement qui correspond à vos besoins — rapidement et en toute confiance.',
                ],
                'features' => [
            ...
            'steps' => [
                ...
                'subtitle' => "De la recherche à l'emménagement, Rezi App vous accompagne à chaque étape.",
                'items' => [
            ...
            'cta' => [
                ...
                'description' => "Rejoignez des centaines d'utilisateurs qui ont déjà trouvé leur résidence idéale sur Rezi App.",
    ...
    public static function defaultContactData(): array
    {
        return [
            ...
            'faq' => [
                ...
                'items' => [
                    [
                        'question' => 'Rezi App est-il gratuit pour les locataires ?',
                    ...
                    [
                        'question' => 'Comment publier mon logement sur Rezi App ?',
    ...
    public static function defaultCguData(): array
    {
        return [
            ...
            'sections' => [
                [
                    'title' => '1. Objet',
                    'content' => "Les présentes Conditions Générales d'Utilisation (ci-après « CGU ») ont pour objet de définir les modalités et conditions d'utilisation de la plateforme Rezi App (ci-après « la Plateforme »), accessible à l'adresse rezi.ci, ainsi que les droits et obligations des parties dans le cadre de l'utilisation de ses services.\n\nRezi App est une plateforme de mise en relation entre propriétaires de résidences meublées et locataires potentiels, opérant principalement à Abidjan, Côte d'Ivoire.",
                ],
                [
                ...
                [
                    ...
                    'content' => "Rezi App agit en tant qu'intermédiaire technique et n'est pas partie aux transactions entre propriétaires et locataires. Rezi App ne peut être tenu responsable de la qualité des résidences, de la véracité des annonces ou du comportement des utilisateurs.",
                ],
                [
                    'title' => '7. Propriété Intellectuelle',
                    'content' => "L'ensemble du contenu de la Plateforme (textes, images, logos, code source) est protégé par le droit de la propriété intellectuelle. Toute reproduction, même partielle, est interdite sans autorisation écrite préalable de Rezi App.",
                ],
                [
                    'title' => '8. Modification des CGU',
                    'content' => "Rezi App se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés des modifications par notification sur la Plateforme. La poursuite de l'utilisation vaut acceptation des nouvelles conditions.",
                ],
                [
        ...
        return [
            ...
            'sections' => [
                [
                    ...
                    'content' => 'Rezi App collecte les données personnelles que vous fournissez lors de votre inscription et utilisation de la plateforme : nom, email, téléphone, adresse, photos de résidences, données de localisation.',
                ],
                [
                ...
                [
                    'title' => '6. Cookies',
                    'content' => "Rezi App utilise des cookies pour améliorer votre expérience de navigation et analyser l'utilisation du site. Vous pouvez configurer votre navigateur pour refuser les cookies.",
                ],
            ],
        ];
    }
    ...
    public static function defaultFaqData(): array
    {
        return [
            ...
            'subtitle' => 'Trouvez rapidement les réponses à vos questions sur Rezi App',
            'categories' => [
                [
                    ...
                    'color' => 'orange',
                    'questions' => [
                        ['question' => 'Comment rechercher une résidence sur Rezi App ?', 'answer' => "Utilisez la barre de recherche sur la page d'accueil ou la carte interactive pour trouver des résidences par commune, type de logement ou budget."],
                        ['question' => 'Est-ce que Rezi App est gratuit pour les locataires ?', 'answer' => 'Oui, la recherche et la consultation des annonces sur Rezi App sont entièrement gratuites.'],
                        ...
                        ['question' => 'Les résidences sont-elles vérifiées ?', 'answer' => 'Toutes les annonces publiées sur Rezi App passent par un processus de modération avant d\'être visibles.'],
                    ],
                ],
                [
                    ...
                    'color' => 'blue',
                    'questions' => [
                        ['question' => 'Comment publier une annonce sur Rezi App ?', 'answer' => "Créez un compte propriétaire, puis accédez à votre tableau de bord. Cliquez sur « Ajouter une résidence » et suivez l'assistant de publication."],
    ...
    public static function defaultTarifsData(): array
    {
        return [
            ...
            'faq' => [
                ...
                [
                    'q' => 'Rezi App prend-il une commission sur mes locations ?',
                    'a' => 'Oui. Rezi App prélève 10% sur le montant total de chaque réservation confirmée, côté propriétaire. Il n\'y a en revanche aucun abonnement mensuel ou annuel à payer.',
                ],
                [
                ...
                [
                    'q' => "Comment Rezi App gagne-t-il de l'argent ?",
                    'a' => 'Rezi App génère ses revenus principalement via une commission de 10% sur le montant total de chaque réservation côté propriétaire, complétée par des options Boost et services premium facultatifs.',
                ],
            ],
        ];
    }
    ...
    public static function defaultGuideProprietaireData(): array
    {
        return [
            ...
            'subtitle'     => 'Tout ce que vous devez savoir pour publier et gérer vos résidences sur Rezi App',
            'introduction' => 'Rezi App est la plateforme de référence pour la location meublée à Abidjan. Que vous ayez un studio ou plusieurs appartements, ce guide vous accompagne pas à pas pour publier, optimiser et rentabiliser vos biens.',
            'steps' => [
                [
                    'number'      => 1,
                    'title'       => 'Créer votre compte propriétaire',
                    'description' => 'Inscrivez-vous sur Rezi App et sélectionnez le rôle « Propriétaire ». Complétez votre profil avec vos informations de contact et une photo.',
                    'substeps'    => [
                ...
                [
                    ...
                    'description' => 'Rezi App propose des outils puissants pour maximiser votre visibilité et remplir vos résidences toute l\'année.',
                    'tools' => [
                        [
                            'icon'        => '🚀',
            ...
            'faq' => [
                [
                    ...
                    'answer'   => 'Oui, la publication d\'une résidence sur Rezi App est entièrement gratuite. Nous proposons des options payantes pour booster votre visibilité (sponsoring, mise en avant).',
                ],
                [
                ...
                [
                    ...
                    'answer'   => 'Rezi App est une plateforme de mise en relation. Les modalités de paiement sont convenues directement entre vous et le locataire. Nous n\'intervenons pas dans les transactions financières.',
                ],
                [
