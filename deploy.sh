...
echo "=============================================================="
echo ""
echo "  Prochaines actions manuelles si ce n'est pas déjà fait :"
echo "  1. Configurer le cron (voir ci-dessous)"
echo "  2. Démarrer le queue worker (voir ci-dessous)"
echo "  3. Vérifier https://votre-domaine.com"
echo ""
